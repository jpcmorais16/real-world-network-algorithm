...
double calculateShortestPathLength(const std::vector<std::vector<int>>& fastGraph, const std::string& executionId = "");

// Checkpoint/resume functions for distance calculation
...
MethodComparisonResult compareAllMethods(int N, double p, double m, double friendship_probability, size_t pairSampleSize = 10000, size_t nodeSampleSize = 10000, const std::string& executionId = "");
